...
class TenantResolverServiceTest {
  ...
  @Mock private TechnicalOrSuperAdminUserTenantResolver technicalOrSuperAdminUserTenantResolver;
  ...
  void resolve_Should_ResolveTenantId_ForTechnicalUserRole() {
    // given
    givenUserIsAuthenticated();
    when(technicalOrSuperAdminUserTenantResolver.canResolve(authenticatedRequest)).thenReturn(true);
    when(technicalOrSuperAdminUserTenantResolver.resolve(authenticatedRequest))
