...
public class RocketChatFacadeTest {
  ...
  @Test
  public void addUserToRocketChatGroup_Should_addUserToGroup()
      throws Exception {
  ...
  public void addUserToRocketChatGroup_Should_throwInternalServerErrorException_When_RocketChatAddUserToGroupExceptionIsThrown()
      throws RocketChatAddUserToGroupException {
    doThrow(new RocketChatAddUserToGroupException("")).when(this.rocketChatService)
  ...
  @Test
  public void removeSystemMessagesFromRocketChatGroup_Should_removeSystemMessagesFromRocketChatGroup()
      throws Exception {
  ...
  @Test(expected = InternalServerErrorException.class)
  public void removeSystemMessagesFromRocketChatGroup_Should_throwInternalServerErrorException_When_RocketChatRemoveSystemMessagesExceptionIsThrown()
      throws Exception {
    doThrow(new RocketChatRemoveSystemMessagesException("")).when(this.rocketChatService)
  ...
  @Test
  public void retrieveRocketChatMembers_Should_retrieveRocketChatMembers()
      throws Exception {
  ...
  @Test(expected = InternalServerErrorException.class)
  public void retrieveRocketChatMembers_Should_throwInternalServerErrorException_When_RocketChatGetGroupMembersException()
      throws Exception {
  ...
  @Test
  public void addTechnicalUserToGroup_Should_addTechnicalUserToGroup()
      throws Exception {
  ...
  @Test(expected = InternalServerErrorException.class)
  public void addTechnicalUserToGroup_Should_throwInternalServerErrorException_When_RocketChatGetGroupMembersException()
      throws Exception {
    doThrow(new RocketChatAddUserToGroupException("")).when(this.rocketChatService)
  ...
  @Test
  public void removeTechnicalUserFromGroup_Should_removeTechnicalUserFromGroup()
      throws Exception {
  ...
  @Test(expected = InternalServerErrorException.class)
  public void removeTechnicalUserFromGroup_Should_throwInternalServerErrorException_When_RocketChatRemoveUserFromGroupException()
      throws Exception {
  ...
  @Test
  public void removeUserFromGroup_Should_removeUserFromGroup()
      throws Exception {
  ...
  @Test(expected = InternalServerErrorException.class)
  public void removeUserFromGroup_Should_throwInternalServerErrorException_When_RocketChatRemoveUserFromGroupExceptionIsThrown()
      throws Exception {
    doThrow(new RocketChatRemoveUserFromGroupException("")).when(this.rocketChatService)
  ...
  @Test
  public void getStandardMembersOfGroup_Should_getStandardMembersOfGroup()
      throws Exception {
