...
public class ConsultantWithWrongTeamConsultantFlagViolationReportRuleTest {
  ...
  @InjectMocks
  private ConsultantWithWrongTeamConsultantFlagViolationReportRule reportRule;
  ...
  public void generateViolations_Should_returnExpectedViolation_When_oneViolatedConsultantExists() {
    ...
    when(this.agencyAdminService.retrieveAllAgencies())
        .thenReturn(singletonList(new AgencyAdminResponseDTO().agencyId(1L).teamAgency(false)));
    ...
    assertThat(resultViolation.getReason(),
        is("Consultant has flag is_team_consultant but assigned agency 1 is not a team agency"));
