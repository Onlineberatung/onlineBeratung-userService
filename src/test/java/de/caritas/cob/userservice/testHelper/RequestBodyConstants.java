...
import static de.caritas.cob.userservice.testHelper.TestConstants.CHAT_DURATION;
import static de.caritas.cob.userservice.testHelper.TestConstants.CHAT_REPETITIVE;
import static de.caritas.cob.userservice.testHelper.TestConstants.CHAT_START_DATE;
import static de.caritas.cob.userservice.testHelper.TestConstants.CHAT_START_TIME;
...
import static de.caritas.cob.userservice.testHelper.TestConstants.TERMS_ACCEPTED;
...
public class RequestBodyConstants {
  ...
  public static final String VALID_USER_REQUEST_BODY_WITH_ENCODED_PASSWORD =
      "{\"username\": \"" + USERNAME + "\"," + "\"postcode\": \"" + POSTCODE + "\", \"agencyId\": "
          ...
          + "\", \"addictiveDrugs\": \"" + ADDICTIVE_DRUGS_VALUE + "\"," + "\"relation\": \""
          + RELATION_VALUE + "\", \"age\": \"" + AGE_VALUE + "\", \"gender\": \"" + GENDER_VALUE
          + "\"," + "\"termsAccepted\": \"" + TERMS_ACCEPTED + "\", \"consultingType\": \""
          + CONSULTING_TYPE_SUCHT.getValue() + "\"}";
  ...
  public static final String INVALID_U25_USER_REQUEST_BODY_AGE =
      "{\"username\": \"" + USERNAME + "\",\" + \"\"postcode\": \"\" + POSTCODE + \"\","
          + "\"agencyId\": " + AGENCY_ID + ", \"agencyId\": " + AGENCY_ID + ", \"password\": \""
          + PASSWORD + "\", \"age\": \"" + INVALID_AGE_VALUE + "\", " + "\"termsAccepted\": \""
          + TERMS_ACCEPTED + "\", \"consultingType\": \"" + CONSULTING_TYPE_U25.getValue() + "\"}";
  public static final String INVALID_U25_USER_REQUEST_BODY_STATE =
      "{\"username\": \"" + USERNAME + "\"," + "\"agencyId\": " + AGENCY_ID + ", \"agencyId\": "
          + AGENCY_ID + ", \"password\": \"" + PASSWORD + "\", \"age\": \"" + AGE_VALUE + "\", "
          + "\"state\": \"" + STATE_VALUE + "\", \"termsAccepted\": \"" + TERMS_ACCEPTED
          + "\", \"consultingType\": \"" + CONSULTING_TYPE_U25.getValue() + "\"}";
  public static final String VALID_U25_USER_REQUEST_BODY = "{\"username\": \"" + USERNAME
      + "\", \"postcode\": \"" + POSTCODE + "\", \"agencyId\": " + AGENCY_ID + ", \"agencyId\": "
      + AGENCY_ID + ", \"password\": \"" + PASSWORD + "\", " + "\"age\": \"" + AGE_VALUE
      + "\", \"state\": \"" + STATE_VALUE + "\", \"termsAccepted\": \"" + TERMS_ACCEPTED
      + "\", \"consultingType\": \"" + CONSULTING_TYPE_U25.getValue() + "\"}";
  public static final String USER_REQUEST_BODY_WITH_USERNAME_TOO_SHORT =
      "{\"username\": \"" + USERNAME_TOO_SHORT + "\"," + "\"postcode\": \"" + POSTCODE
          + "\", \"agencyId\": " + AGENCY_ID + ", \"password\": \"" + PASSWORD + "\","
          + "\"email\": \"" + EMAIL + "\", \"addictiveDrugs\": \"" + ADDICTIVE_DRUGS_VALUE + "\","
          + "\"relation\": \"" + RELATION_VALUE + "\", \"age\": \"" + AGE_VALUE
          + "\", \"gender\": \"" + GENDER_VALUE + "\"," + "\"termsAccepted\": \"" + TERMS_ACCEPTED
          + "\", \"consultingType\": \"" + CONSULTING_TYPE_SUCHT.getValue() + "\"}";
  public static final String USER_REQUEST_BODY_WITH_USERNAME_TOO_LONG =
      "{\"username\": \"" + USERNAME_TOO_LONG + "\"," + "\"postcode\": \"" + POSTCODE
          + "\", \"agencyId\": " + AGENCY_ID + ", \"password\": \"" + PASSWORD + "\","
          + "\"email\": \"" + EMAIL + "\", \"addictiveDrugs\": \"" + ADDICTIVE_DRUGS_VALUE + "\","
          + "\"relation\": \"" + RELATION_VALUE + "\", \"age\": \"" + AGE_VALUE
          + "\", \"gender\": \"" + GENDER_VALUE + "\"," + "\"termsAccepted\": \"" + TERMS_ACCEPTED
          + "\", \"consultingType\": \"" + CONSULTING_TYPE_SUCHT.getValue() + "\"}";
  public static final String VALID_CREATE_CHAT_BODY = "{ \"topic\": \"" + CHAT_TOPIC
