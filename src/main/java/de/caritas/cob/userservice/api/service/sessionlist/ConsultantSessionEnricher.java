...
public class ConsultantSessionEnricher {
  ...
  private void enrichConsultantSession(ConsultantSessionResponseDTO consultantSessionResponseDTO,
    ...
    messageUpdater.updateSessionWithAvailableLastMessage(consultantSessionResponseDTO.getSession(),
        consultantSessionResponseDTO::setLatestMessage, rocketChatRoomInformation,
