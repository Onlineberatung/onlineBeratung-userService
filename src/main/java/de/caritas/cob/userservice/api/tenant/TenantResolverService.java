...
public class TenantResolverService {
  ...
  @NonNull TechnicalOrSuperAdminUserTenantResolver technicalOrSuperAdminUserTenantResolver;
  ...
  private ArrayList<TenantResolver> authenticatedTenantResolvers() {
    return newArrayList(technicalOrSuperAdminUserTenantResolver, accessTokenTenantResolver);
  }
